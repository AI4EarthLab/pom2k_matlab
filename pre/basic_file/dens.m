...
% *                                                                    *
% **********************************************************************
global tbias sbias rhor rhoref grav zz_3d 
...
rhor=-0.157406e0+6.793952e-2*tr-9.095290e-3*tr2+1.001685e-4*tr3-1.120083e-6*tr4+6.536332e-9*tr4.*tr;

rhor=rhor+(0.824493e0-4.0899e-3*tr+7.6438e-5*tr2-8.2467e-7*tr3+5.3875e-9*tr4).*sr+(-5.72466e-3+1.0227e-4*tr ...
