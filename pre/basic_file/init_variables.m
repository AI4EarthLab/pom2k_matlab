...
wubot1=zeros(im,jm)  ;wvbot1=zeros(im,jm)  ;z=zeros(1,kb)        ;zz=zeros(1,kb)       ;
dz=zeros(1,kb)       ;dzz=zeros(1,kb)      ;z_3d=zeros(im,jm,kb) ;zz_3d=zeros(im,jm,kb);
dz_3d=zeros(im,jm,kb);dzz_3d=zeros(im,jm,kb);
