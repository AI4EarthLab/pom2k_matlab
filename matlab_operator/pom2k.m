...
elseif(iproblem ==3)
    ...
    [dx,dy,cor,...
        ...
        h,art,aru,arv,fsm,dum,dvm,...
        tb,sb,tclim,sclim,ub,uab,elb,etb,dt,...
        aam2d,rho,rmean,rfe,rfw,rfn,rfs,uabw,uabe,ele,elw,tbe,tbw,sbe,sbw,...
        tbn,tbs,sbn,sbs,rot,els,eln,vabs,vabn,ubw,ube,vbs,vbn,...
...
[rho,drhox,drhoy] = baropg(rho, rmean, dt, ramp);
