...
for iint=1:iend
    ...
    swrad,wssurf,u,ub,v,vb,dt_3d,aam,rho,rmean,ramp,uab,vab,ua,va,d,t,s,w,el);
        ...
        for iext=1:isplit    % Begin external (2-D) mode
            ...
            [uaf,advua] = cal_ua(h,elb,el,elf,uab,vab,adx2d,drx2d,advua,d,va,e_atmos,wusurf,wubot,iext,aam2d,ua,ramp);
            
            [vaf,advva] = cal_va(h,elb,el,elf,uab,vab,ady2d,dry2d,advva,d,ua,e_atmos,wvsurf,wvbot,iext,aam2d,va,ramp);
