function [q2f,q2,q2b,q2lf,q2l,q2lb,km,kq,kh]=internal_q(q2b,q2,q2lb,q2l,dt_3d,u,v,w,aam,etb,etf,rho,wusurf,wubot,wvsurf,wvbot,km,kq,kh,t,s)
...
q2f= ( q2b.*(h_3d+repmat(etb,1,1,kb))  -dti2*( -DZB(AZF(w.*q2)) + DXF(AXB(q2) .* AXB(dt_3d) .* AZB(u) ... 
     -AZB( AXB( aam )).*AXB(h_3d) .*DXB( q2b ).* dum_3d) + DYF(AYB(q2) .* AYB(dt_3d) .* AZB(v) ...
     -AZB( AYB( aam )).*AYB(h_3d) .*DYB( q2b ).* dvm_3d)) )./  ( h_3d+repmat(etf,1,1,kb) ) ;

q2lf= ( q2lb .* (h_3d+repmat(etb,1,1,kb)) -dti2*( -DZB(AZF(w.*q2l)) + DXF(AXB(q2l) .* AXB(dt_3d) .* AZB(u) ...
