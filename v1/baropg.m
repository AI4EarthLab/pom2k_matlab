...
% *                                                                    *
% **********************************************************************
global im jm kb zz_3d dx_3d dy_3d grav dum_3d dvm_3d gs;
...
drhox=ramp * grav * AXB(dt_3d) .* SUMZ(-DZB(zz_3d) .* AXB(dt_3d) .* DXB(AZB(rho)) + AZB(zz_3d) .* DXB(dt_3d) .* DZB(AXB(rho)));
...
drhoy=ramp * grav .* AYB(dt_3d) .* SUMZ(-DZB(zz_3d) .* AYB(dt_3d) .* DYB(AZB(rho)) + AZB(zz_3d) .* DYB(dt_3d) .* DZB(AYB(rho)));
